...
"""
Tâches: utilisez une condition IF pour écrire une phrase qui varie fonction de
l'augmentation ou la diminution du taux de chomage pour chaque municipalité.
"""
